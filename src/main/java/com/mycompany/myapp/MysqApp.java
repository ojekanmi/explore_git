...
public class MysqApp {

    private static final Logger log = LoggerFactory.getLogger(MysqApp.class);

    private final Environment env;

    public MysqApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(MysqApp.class);
